document.addEventListener("DOMContentLoaded", function () {
    ...
    const jsonURL = "http://localhost:3000/pedidosDomingo";
    ...
    async function cancelarPedido(pedidoId) {
        ...
        const deleteResponse = await fetch(`http://localhost:3000/pedidosDomingo/${pedidoId}`, {
            method: 'DELETE'
        });
    ...
    fetch(jsonURL)
       ...
       confirmarBorrarBoton.addEventListener("click", async () => {
           ...
           do {
               ...
               const response = await fetch('http://localhost:3000/pedidosDomingo');
               ...
               for (let i = 0; i < pedidos.length; i++) {
                   ...
                   if (pedido.ver === true) {
                       ...
                       const patchResponse = await fetch(`http://localhost:3000/pedidosDomingo/${idDelPedido}`, {
                           method: 'PATCH',
                           headers: {
